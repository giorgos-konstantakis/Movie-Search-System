...
function PopularPeople(props) {
    ...
    const firstPage = () => {
        return (
            <div className="text-center col-md-12">
                ...
                <Link to={`/people_and_organizations/popular_people_reverse/page/${popularPeople.page + 3}`}>
    ...
    const renderPages = () => {
        return (
            <div className="text-center col-md-12">
                <span className="mr-5">Results: {(popularPeople.page - 1) * 20 + 1} - {popularPeople3.page * 20}</span>
                <Link className="mr-5" to={`/people_and_organizations/popular_people_reverse/page/${popularPeople.page - 3}`}>
                    <button type="button" className="btn btn-dark">
                        <i class="fas fa-angle-double-left mr-2"></i>Previous Page
                </button>
                </Link>
