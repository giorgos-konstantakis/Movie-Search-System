...
function PopularMovies(props) {
    ...
    const lastPage = () => {
        return (
            <div className="text-center col-md-12">
                <span className="mr-5">Results: {(popularMovies.page - 1) * 20 + 1} - {(popularMovies.page - 1) * 20 + 1 + count}</span>
                <Link to={`/movies/popular_movies_reverse/page/${popularMovies.page - 3}`}>
                    <button type="button" className="btn btn-dark">
    ...
    const renderPages = () => {
        return (
            <div className="text-center col-md-12">
                <span className="mr-5">Results: {(popularMovies.page - 1) * 20 + 1} - {popularMovies3.page * 20}</span>
                <Link className="mr-5" to={`/movies/popular_movies_reverse/page/${popularMovies.page - 3}`}>
                    <button type="button" className="btn btn-dark">
                        <i class="fas fa-angle-double-left mr-2"></i>Previous Page
                </button>
                </Link>
