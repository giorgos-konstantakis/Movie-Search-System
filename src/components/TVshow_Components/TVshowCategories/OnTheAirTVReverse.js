...
function OnTheAirTVReverse(props) {
    var count = 0;
    ...
    const firstPage = () => {
        return (
            <div className="text-center col-md-12">
                ...
                <Link className="card-header-font-sz" to={`/tv_shows/on_the_air_tv/page/${onTheAir.page + 3}`}>
    ...
    const renderPages = () => {
        return (
            <div className="text-center col-md-12">
                <span className="mr-5 card-header-font-sz text-white">Results: {(onTheAir.page - 1) * 20 + 1} - {onTheAir3.page * 20}</span>
                <Link className="mr-5 card-header-font-sz" to={`/tv_shows/on_the_air_tv/page/${onTheAir.page - 3}`}>
                    <button type="button" className="btn btn-outline-dark card-header-font-sz text-white p-2">
                        <i class="fas fa-angle-double-left mr-2"></i>Previous Page
                </button>
                </Link>
...
export default OnTheAirTVReverse;